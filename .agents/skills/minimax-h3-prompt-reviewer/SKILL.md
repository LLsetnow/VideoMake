...
Before reviewing, read `../minimax-h3-prompt/SKILL.md`, then read `../minimax-h3-prompt/reference/VIDEO_PROMPT_WRITING_GUIDE_base_en.md` for T2VA/I2VA/FL2VA/L2VA or `../minimax-h3-prompt/reference/VIDEO_PROMPT_WRITING_GUIDE_ref_en.md` for Ref2VA. Treat `minimax-h3-prompt` and its bundled guide files as the canonical validation standard. If this skill or its local checklist conflicts with them, follow the canonical files.
